export const favorites = localStorage;
...
export const errorTitle = charWindow.querySelector('.errorbox');
export const characterPreloder = charWindow.querySelector('.preloader')
...
export const locationCharBox = document.querySelector("#location__char_box").content;
